...
# 文件路径
input_file = r"C:\Users\sq\Desktop\grid5\grid5.xlsx"
output_dir = r"C:\Users\sq\Desktop\grid5\12.2结果2（ln设施点+1）"
...
# 模型特点说明
print("\n模型特点说明:")
print("本模型使用对数形式的设施点数量: ln(i_count) 和 ln(j_count+1)")
print("这种形式可以处理设施点数量为0的情况（通过对j_count加1）")
print("同时，对数变换可以减小变量的尺度差异，使模型更稳定")