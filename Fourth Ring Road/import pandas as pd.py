...
# 文件路径
input_file = r"C:\Users\sq\Desktop\grid4\grid4.xlsx"
output_dir = r"C:\Users\sq\Desktop\grid4\12.2结果2（ln设施点+1）"
...
for _, row in sig_vars.iterrows():
    ...
    direction = "正向" if coef > 0 else "负向"  # 这里定义的是英文变量名direction
    print(f"  {var}: 系数={coef:.4f}, P值={pval:.4e} ({significance}, {direction}影响)")  # 这里要使用direction，不是方向
